...
type
  TdmR = class(TDataModule)
    ...
    qCategoriesCATEGORY: TWideStringField;
    cdsCategoriesID: TSmallintField;
    cdsCategoriesCATEGORY: TWideStringField;
    qCompaniesSETUPID: TIntegerField;
    qCompaniesCOMPANYNAME: TWideStringField;
    cdsCompaniesSETUPID: TIntegerField;
    cdsCompaniesCOMPANYNAME: TWideStringField;
    qEquipmentID: TSmallintField;
    qEquipmentEQUIPMENT: TWideStringField;
    qEquipmentROOMID: TSmallintField;
    qEquipmentMANUFACTURERID: TSmallintField;
    qEquipmentCELL: TWideStringField;
    qEquipmentPHONE: TWideStringField;
    qEquipmentFAX: TWideStringField;
    qEquipmentCONTACT: TWideStringField;
    qEquipmentEMAIL: TWideStringField;
    qEquipmentCOMMENTS: TBlobField;
    cdsEquipmentID: TSmallintField;
    cdsEquipmentEQUIPMENT: TWideStringField;
    cdsEquipmentROOMID: TSmallintField;
    cdsEquipmentMANUFACTURERID: TSmallintField;
    cdsEquipmentCELL: TWideStringField;
    cdsEquipmentPHONE: TWideStringField;
    cdsEquipmentFAX: TWideStringField;
    cdsEquipmentCONTACT: TWideStringField;
    cdsEquipmentEMAIL: TWideStringField;
    cdsEquipmentCOMMENTS: TBlobField;
    qManufacturersMANUFACTURERID: TSmallintField;
    qManufacturersMANUFACTURER: TWideStringField;
    qManufacturersCITY: TWideStringField;
    qManufacturersSTATEPROV: TWideStringField;
    qManufacturersCOUNTRY: TWideStringField;
    qManufacturersCELL: TWideStringField;
    qManufacturersPHONE: TWideStringField;
    qManufacturersFAX: TWideStringField;
    qManufacturersEMAIL: TWideStringField;
    qManufacturersWEBSITE: TWideStringField;
    qManufacturersCONTACT: TWideStringField;
    qManufacturersCOMMENTS: TBlobField;
    cdsManufacturersMANUFACTURERID: TSmallintField;
    cdsManufacturersMANUFACTURER: TWideStringField;
    cdsManufacturersCITY: TWideStringField;
    cdsManufacturersSTATEPROV: TWideStringField;
    cdsManufacturersCOUNTRY: TWideStringField;
    cdsManufacturersCELL: TWideStringField;
    cdsManufacturersPHONE: TWideStringField;
    cdsManufacturersFAX: TWideStringField;
    cdsManufacturersEMAIL: TWideStringField;
    cdsManufacturersWEBSITE: TWideStringField;
    cdsManufacturersCONTACT: TWideStringField;
    cdsManufacturersCOMMENTS: TBlobField;
    qRoomsID: TSmallintField;
    qRoomsROOM: TWideStringField;
    qRoomsCOMPANYID: TSmallintField;
    cdsRoomsID: TSmallintField;
    cdsRoomsROOM: TWideStringField;
    cdsRoomsCOMPANYID: TSmallintField;
    qTechniciansTECHNICIANID: TSmallintField;
    qTechniciansTECHNICIAN: TWideStringField;
    cdsTechniciansTECHNICIANID: TSmallintField;
    cdsTechniciansTECHNICIAN: TWideStringField;
    Query1ISSUEID: TIntegerField;
    Query1PROBLEMSHORT: TWideStringField;
    Query1DATEENTERED: TSQLTimeStampField;
    Query1COMPLETE: TWideStringField;
    cdsQuery1ISSUEID: TIntegerField;
    cdsQuery1PROBLEMSHORT: TWideStringField;
    cdsQuery1DATEREPAIRED: TSQLTimeStampField;
    cdsQuery1DATEENTERED: TSQLTimeStampField;
    cdsQuery1COMPLETE: TWideStringField;
    Query1EQUIPMENT: TWideStringField;
    cdsQuery1EQUIPMENT: TWideStringField;
    Query1DATEREPAIRED: TSQLTimeStampField;
    qIssueDetails: TSQLQuery;
    qIssueDetailsISSUEID: TIntegerField;
    qIssueDetailsPROBLEMSHORT: TWideStringField;
    qIssueDetailsPROBLEM: TBlobField;
    qIssueDetailsEQUIPMENTID: TSmallintField;
    qIssueDetailsTECHNICIANID: TSmallintField;
    qIssueDetailsSOLUTION: TBlobField;
    ...
    qIssueDetailsCOMPLETE: TWideStringField;
    ...
    cdsIssueDetailsCOMPLETE: TWideStringField;
    qYesNo: TSQLQuery;
